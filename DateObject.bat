...
::|                                                                                                              |
::| @param [in]  {number}   MonthPerRow - Le nombre de mois affiché par ligne                                    |
::|                                                                                                              |
::| @param [in]  {number}   Year        - L'année                                                                |
::|                                                                                                              |
::| @example                                                                                                     |
...
::|                                                                                                              |
::| @param [out] {CalendarMonth} CalendarMonthMerged   - Le mois 1 et le mois 2 fusionné                         |
::|                                                                                                              |
::| @example                                                                                                     |
::|                                                                                                              |
::|    setlocal enabledelayedexpansion                                                                           |
...
::|                                                                                                              |
::| @param [in]  {string}  DaysMin     - La liste des jours (abréviation sur 2 lettres)                          |
::|                                                                                                              |
...
::| Permet de construire le calendrier d'un mois                                                                 |
::|                                                                                                              |
::| @param [out] {number}   Length   - La longueur de la chaîne de caractères                                    |
::|                                                                                                              |
::| @param [in]  {variable} Variable - Le nom de la variable qui contient la chaîne de caractères                |
::|                                                                                                              |
::| @example                                                                                                     |
::|                                                                                                              |
::|    set test=salut                                                                                            |
